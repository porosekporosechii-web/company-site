...
export function Banner({
  ...
  subtitle = 'Оформляем торговые пространства, производим наружную рекламу, торговое оборудование, декорации, LED-экраны и текстильные лайтбоксы. Собственный цех 800 м² в Москве.',
  stats = defaultStats,
}: BannerProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-graphite min-h-[88vh]">
      <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-[0.55]" style={{ backgroundImage: "url('/banner.png')" }} />
