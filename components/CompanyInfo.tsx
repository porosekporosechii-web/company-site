...
const features = [
  {
    ...
    description: 'Цех 800 м² — проектирование, изготовление, покраска и монтаж без субподрядчиков',
  },
  {
    title: 'Шесть направлений',
    description: 'POS-оформление, торговое оборудование, наружная реклама, LED-экраны, декорации, лайтбоксы',
  },
  {
    title: 'Гарантия и монтаж',
    description: 'Гарантия на все изделия. Доставка и монтаж по Москве и МО. Выезд на замер бесплатно',
  },
  {
